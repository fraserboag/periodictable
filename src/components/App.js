		...
		return (
			<div className="container" onKeyDown={this.handleKeyDown} tabIndex="0">
				...
				<div className="creditarea">
					<span className="credit">Just a little side project by web developer <a href="https://www.boag.online" target="_blank" rel="noopener noreferrer">Fraser Boag</a>. Please feel free to get in touch via my personal website if you have any suggestions, corrections or questions. Find this useful and want to say thanks? <a href="https://www.buymeacoffee.com/boag" target="_blank" rel="noopener noreferrer">Buy me a beer!</a></span>
				</div>
			</div>
		);
	}
